 ...
 * @author julia
 */
public class MessageReaderDesktopServerThread extends Thread{
    ...
    public MessageReaderDesktopServerThread() {
        ...
        try {
            ...
            while (statusServidor && !isInterrupted()) {
                ...
                try {
                    ...
                    if (statusServidor) {
                        JOptionPane.showMessageDialog(null, "Erro ao atender cliente leitura Desktop: " + error.getMessage());
                    }
                }
            }
        } catch (Exception error) {
            if (statusServidor == true) {
                JOptionPane.showMessageDialog(null, "Erro no módulo desktop (leitura): " + error.getMessage());
            }
        }
    }
    ...
    public void FecharServer() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao parar módulo desktop (leitura): " + error.getMessage());
        }
    }
}
